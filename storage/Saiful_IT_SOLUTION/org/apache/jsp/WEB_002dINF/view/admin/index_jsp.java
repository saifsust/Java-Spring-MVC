...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<script src='<c:url value=\"admin/js/core/jquery.min.js\"/>'\n");
      out.write("\t\ttype=\"text/javascript\"></script>\n");
      out.write("\t<script src='<c:url value = \"admin/js/core/popper.min.js\"/>'\n");
      out.write("\t\ttype=\"text/javascript\"></script>\n");
      out.write("\t<script\n");
      out.write("\t\tsrc='<c:url value= \"admin/js/core/bootstrap-material-design.min.js\"/>'\n");
      out.write("\t\ttype=\"text/javascript\"></script>\n");
      out.write("\t<script\n");
      out.write("\t\tsrc='<c:url value = \"admin/js/plugins/perfect-scrollbar.jquery.min.js\"/>'></script>\n");
      out.write("\t<!--  Google Maps Plugin    -->\n");
      out.write("\t<script\n");
      out.write("\t\tsrc='<c:url value = \"https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE\"/>'></script>\n");
      out.write("\t<!-- Chartist JS -->\n");
      out.write("\t<script src='<c:url value =\"admin/js/plugins/chartist.min.js\"/>'></script>\n");
      out.write("\t<!--  Notifications Plugin    -->\n");
      out.write("\t<script src='<c:url value = \"admin/js/plugins/bootstrap-notify.js\"/>'></script>\n");
      out.write("\t<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->\n");
      out.write("\t<script\n");
      out.write("\t\tsrc='<c:url value = \"admin/js/material-dashboard.min.js?v=2.1.0\"/>'\n");
      out.write("\t\ttype=\"text/javascript\"></script>\n");
      out.write("\t<!-- Material Dashboard DEMO methods, don't include it in your project! -->\n");
      out.write("\t<script src='<c:url value =\"admin/demo/demo.js\"/>'></script>\n");
      out.write("\t<script>\n");
