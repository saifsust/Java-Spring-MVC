...
import com.application.views.SocialMediaView;
...
public class ViewFactory {
	...
	public static View getView(String viewType) {
		...
		if (viewType.equalsIgnoreCase("CLIENT") || viewType.equalsIgnoreCase("client"))
		...
		if (viewType.equalsIgnoreCase("SOCIAL-MEDIA") || viewType.equalsIgnoreCase("social-media"))
